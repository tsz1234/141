		...
		<div :style='{"padding":"20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","background":"none","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="traveldemandChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 45px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) center center/100% 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="traveldemandChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="traveldemandChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"padding":"0 0 10px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"10px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"84px"}'>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"175px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>出行需求总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"rgb(30, 144, 255)","fontWeight":"bold","height":"24px","order":"20"}'>{{traveldemandCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts7">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="traveldemandChart7" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts8">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<el-table id="traveldemandTable" :data="traveldemandList" border :stripe="true" :style='{"padding":"0","borderColor":"#eee","overflow":"auto","borderWidth":"0","background":"none","width":"100%","borderStyle":"solid","height":"calc(100% - 65px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="starttime" label="开始时间"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jieshushijian" label="结束时间"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="kaishizhandian" label="开始站点"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jieshuzhandian" label="结束站点"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="qixingshizhang" label="骑行时长(分钟)"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="qixingjuli" label="骑行距离(公里)"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="traveldemandChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="traveldemandChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="traveldemandChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		...
		created() {
			this.$nextTick(()=>{
				this.times()
				setTimeout(()=>{
					this.gettraveldemandCount();
					this.traveldemandChat1();
					this.traveldemandChat2();
					this.traveldemandChat3();
					this.traveldemandChat4();
					this.traveldemandChat5();
					this.traveldemandChat6();
					this.traveldemandChat7();
				},500)
			})
		},
		methods:{
			gettraveldemandList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.traveldemandList = data.data.list;
						let div = document.getElementById('traveldemandTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.traveldemandTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.traveldemandTimer);
						})
			...
			gettraveldemandCount() {
				this.$http({
					url: `traveldemand/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.traveldemandCount = data.data
					}
				})
			},
			//统计接口1
			traveldemandChat1() {
				this.$nextTick(()=>{
					...
					var traveldemandChart1 = echarts.init(document.getElementById("traveldemandChart1"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							traveldemandChart1.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								traveldemandChart1.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			traveldemandChat2() {
				this.$nextTick(()=>{
					...
					var traveldemandChart2 = echarts.init(document.getElementById("traveldemandChart2"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							traveldemandChart2.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								traveldemandChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			traveldemandChat3() {
				this.$nextTick(()=>{
					...
					var traveldemandChart3 = echarts.init(document.getElementById("traveldemandChart3"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							traveldemandChart3.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								traveldemandChart3.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			traveldemandChat4() {
				this.$nextTick(()=>{
					...
					var traveldemandChart4 = echarts.init(document.getElementById("traveldemandChart4"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							traveldemandChart4.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								traveldemandChart4.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			traveldemandChat5() {
				this.$nextTick(()=>{
					...
					var traveldemandChart5 = echarts.init(document.getElementById("traveldemandChart5"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							traveldemandChart5.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								traveldemandChart5.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
			...
			traveldemandChat6() {
				this.$nextTick(()=>{
					...
					var traveldemandChart6 = echarts.init(document.getElementById("traveldemandChart6"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							traveldemandChart6.setOption(option);


							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								traveldemandChart6.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
